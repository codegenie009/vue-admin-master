    ...
    children: [
      {
        name: 'feed',
        path: 'feed',
        component: () => import('@/pages/admin/feed/Feed.vue'),
      },
      {
        name: 'analytics',
        path: 'analytics',
        ...
        children: [
          {
            name: 'transactions',
            path: 'transactions',
            component: () => import('@/pages/admin/analytics/transactions/Transactions.vue'),
            meta: {
          ...
          },
          {
            name: 'subscriptions',
            path: 'subscriptions',
            component: () => import('@/pages/admin/analytics/subscriptions/Subscriptions.vue'),
            meta: {
              // wikiLink: 'https://github.com/epicmaxco/vuestic-admin/wiki/Charts',
            },
          },
          {
            name: 'users',
            path: 'users',
            component: () => import('@/pages/admin/analytics/users/Users.vue'),
            meta: {
              // wikiLink: 'https://github.com/epicmaxco/vuestic-admin/wiki/Charts',
            },
          },
          {
            name: 'countries',
            path: 'countries',
            component: () => import('@/pages/admin/analytics/countries/Countries.vue'),
            meta: {
              // wikiLink: 'https://github.com/epicmaxco/vuestic-admin/wiki/Charts',
            },
          },
          {
            ...
            component: () => import('@/pages/admin/analytics/payment-systems/PaymentSystems.vue'),
            meta: {
              // wikiLink: 'https://github.com/epicmaxco/vuestic-admin/wiki/Charts',
            },
          },
          {
            name: 'currencies',
            path: 'currencies',
            component: () => import('@/pages/admin/analytics/currencies/Currencies.vue'),
            meta: {
              // wikiLink: 'https://github.com/epicmaxco/vuestic-admin/wiki/Charts',
            },
          },
          {
            name: 'price_points',
            path: 'price_points',
            component: () => import('@/pages/admin/analytics/price-points/PricePoints.vue'),
            meta: {
              // wikiLink: 'https://github.com/epicmaxco/vuestic-admin/wiki/Charts',
            },
          },
          {
            name: 'spiderpipe',
            path: 'spiderpipe',
            component: () => import('@/pages/admin/analytics/spiderpipe-accounts/SpiderPipeAccounts.vue'),
            meta: {
              // wikiLink: 'https://github.com/epicmaxco/vuestic-admin/wiki/Charts',
            },
          },
      ...
      },
      {
        name: 'payouts',
        path: 'payouts',
        component: () => import('@/pages/admin/payouts/Payouts.vue'),
      },
      {
        name: 'my_projects',
        path: 'payouts',
        component: () => import('@/pages/admin/my-projects/MyProjects.vue'),
      },
      {
        name: 'marketing_tools',
        path: 'payouts',
        component: () => import('@/pages/admin/marketing-tools/MarketingTools.vue'),
      },
      {
